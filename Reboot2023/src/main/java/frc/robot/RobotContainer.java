...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    // whileTrue - continue running the command while the button is pressed.
    // Command is no longer scheduled when the button is release.
    m_driverController.a().whileTrue(m_lightSubystem.setRainbowCommand());
